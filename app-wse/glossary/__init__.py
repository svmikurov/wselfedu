...
It has the functionality of adding terms and displaying a list of them.
Currently, development of the package is suspended. In the future, work
on the project is expected to be resumed.
"""
