...
urlpatterns = [
    ...
    path('glossary/', include((terms_router.urls, 'glossary_api'), namespace='glossary_api')),  # noqa: E501
    path('lang/', include((lang_router.urls, 'lang_api'), namespace='lang_api')),  # noqa: E501
]
# fmt: on
