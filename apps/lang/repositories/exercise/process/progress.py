...
class _UpdateProgressProtocol(Protocol):
    """Protocol for update progress DTO."""
...
class ProgressRepository(
    AbstractProcessExerciseRepository[_UpdateProgressProtocol, None]
):
    ...
    @override
    @transaction.atomic
    def update(self, user: Person, command: _UpdateProgressProtocol) -> None:
        """Update."""
        pk = command.pk
        delta = command.delta
