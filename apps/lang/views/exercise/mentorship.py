...
from apps.lang.models import LanguageExercise
...
class MentorExerciseListView(
    ...
    def get_queryset(self) -> QuerySet[LanguageExercise]:
...
class MentorExerciseUpdateView(
    auth.OwnershipRequiredMixin[LanguageExercise],
    crud.UserActionKwargsFormMixin,
