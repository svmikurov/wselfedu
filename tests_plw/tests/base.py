"""The base page test of Page Object Model."""
...
class UserMixin:
    ...
    def create_user(
        ...
        :param username: The name of created user, "user" by default.
        :return: The user model instance if given ``username``
         parameter, None otherwise and create ``user`` class attribute.
        :rtype: Optional[UserModel]
